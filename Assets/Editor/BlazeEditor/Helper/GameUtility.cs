...
public class GameUtility
{
    ...
    public static bool SafeWriteAllBytes(string outFile, byte[] outBytes)
    {
        ...
        {
            Tuner.Error(string.Format("SafeWriteAllBytes failed! path = {0} with err = {1}", outFile, ex.Message));
    ...
    public static bool SafeWriteAllLines(string outFile, string[] outLines)
    {
        ...
        {
            Tuner.Error(string.Format("SafeWriteAllLines failed! path = {0} with err = {1}", outFile, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeWriteAllText(string outFile, string text)
    {
        ...
        {
            Tuner.Error(string.Format("SafeWriteAllText failed! path = {0} with err = {1}", outFile, ex.Message));
            return false;
        }
    }
    ...
    public static byte[] SafeReadAllBytes(string inFile)
    {
        ...
        {
            Tuner.Error(string.Format("SafeReadAllBytes failed! path = {0} with err = {1}", inFile, ex.Message));
            return null;
        }
    }
    ...
    public static string[] SafeReadAllLines(string inFile)
    {
        ...
        {
            Tuner.Error(string.Format("SafeReadAllLines failed! path = {0} with err = {1}", inFile, ex.Message));
            return null;
        }
    }
    ...
    public static string SafeReadAllText(string inFile)
    {
        ...
        {
            Tuner.Error(string.Format("SafeReadAllText failed! path = {0} with err = {1}", inFile, ex.Message));
            return null;
        }
    }
    ...
    public static bool SafeClearDir(string folderPath)
    {
        ...
        {
            Tuner.Error(string.Format("SafeClearDir failed! path = {0} with err = {1}", folderPath, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeDeleteDir(string folderPath)
    {
        ...
        {
            Tuner.Error(string.Format("SafeDeleteDir failed! path = {0} with err: {1}", folderPath, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeDeleteFile(string filePath)
    {
        ...
        {
            Tuner.Error(string.Format("SafeDeleteFile failed! path = {0} with err: {1}", filePath, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeRenameFile(string sourceFileName, string destFileName)
    {
        ...
        {
            Tuner.Error(string.Format("SafeRenameFile failed! path = {0} with err: {1}", sourceFileName, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeCopyFile(string fromFile, string toFile)
    {
        ...
        {
//            Tuner.Error(string.Format("SafeCopyFile failed! formFile = {0}, toFile = {1}, with err = {2}",
