...
namespace SuperScrollView
{
    ...
    [AddComponentMenu("UI/LoopGridView", 39)]
    public class LoopGridView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        System.Action<bool> mOnListViewInitedCall;
        ...
        public void InitGridView(int itemTotalCount,
          ...
          System.Action<bool> onListViewInitedCall)
        {
            InitGridView(itemTotalCount, onGetItemByRowColumn, null, null, onListViewInitedCall);
        }
        ...
        */
        public void InitGridView(int itemTotalCount,
            ...
            LoopGridViewInitParam initParam = null, System.Action<bool> onListViewInitedCall = null)
        {
            ...
            mOnListViewInitedCall = onListViewInitedCall;
        ...
        */
        ...
        void Update()
        {
            ...
            if (mOnListViewInitedCall != null)
            {
                mOnListViewInitedCall(true);
                mOnListViewInitedCall = null;
            }
        }
