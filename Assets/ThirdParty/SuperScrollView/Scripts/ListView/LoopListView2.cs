...
namespace SuperScrollView
{
    ...
    [AddComponentMenu("UI/LoopListView2", 39)]
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        [SerializeField] protected ListItemArrangeType mArrangeType = ListItemArrangeType.TopToBottom;
        ...
        protected List<LoopListViewItem2> mItemList = new List<LoopListViewItem2>();
        protected RectTransform mContainerTrans;
        ...
        [SerializeField] protected bool mSupportScrollBar = true;
        protected bool mIsDraging = false;
        protected PointerEventData mPointerEventData = null;
        ...
        protected Vector3 mLastFrameContainerPos = Vector3.zero;
        ...
        protected Vector2 mAdjustedVec;
        protected bool mNeedAdjustVec = false;
        ...
        */
        public virtual void OnItemSizeChanged(int itemIndex, float stretchTime = 0)
        {
            ...
            UpdateContentSize();
            UpdateAllShownItemsPos(stretchTime);
        }
        ...
        */
        ...
        protected void SetItemSize(int itemIndex, float itemSize, float padding)
        {
        ...
        protected float GetItemPos(int itemIndex)
        {
        ...
        public virtual void UpdateAllShownItemsPos(float stretchTime = 0)
        {
            int count = mItemList.Count;
            if (count == 0)
            {
            ...
            if (mArrangeType == ListItemArrangeType.TopToBottom)
            {
                ...
                for (int i = 0; i < count; ++i)
                {
                    ...
                    if (stretchTime == 0)
                        ...
                        item.CachedRectTransform.DOAnchorPos3D(new Vector3(item.StartPosOffset, curY, 0), stretchTime);
            ...
            else if (mArrangeType == ListItemArrangeType.LeftToRight)
            {
                ...
                for (int i = 0; i < count; ++i)
                {
                    ...
                    if (stretchTime == 0)
                        ...
                        item.CachedRectTransform.DOAnchorPos3D(new Vector3(curX, item.StartPosOffset, 0), stretchTime);
