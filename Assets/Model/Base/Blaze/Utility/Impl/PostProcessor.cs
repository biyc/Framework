...
public class PostProcessor : MonoBehaviour
{
    ...
    [Tooltip(
        "Post processor settings, to create new press right click in project view then: Create -> Mobile Optimized Post Processing -> PostProcessorSettings")]
    ...
    void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
    {
        ...
        {
            RenderTexture Blurred = ApplyBlur(currentTarget, sourceTexture, Settings.BlurRadius,
                Settings.BlurTextureResolutionDivider, Settings.BlurIterations);
            ReleaseTemporary(currentTarget, sourceTexture);
    ...
    private RenderTexture ApplyBlur(RenderTexture currentTarget, RenderTexture sourceTexture, float BlurRadius,
        float BlurTextureResolutionDivider, int Iterations)
    {
        ...
        RenderTexture blurTarget = RenderTexture.GetTemporary(
            (int) (currentTarget.width / BlurTextureResolutionDivider),
        ...
        {
            RenderTexture nextTarget = RenderTexture.GetTemporary(
                (int) (currentTarget.width / BlurTextureResolutionDivider),
                (int) (currentTarget.height / BlurTextureResolutionDivider));
    ...
    private void ApplyBloom(RenderTexture from, RenderTexture to, RenderTexture sourceTexture)
    {
        ...
        RenderTexture FilteredScene = RenderTexture.GetTemporary(
            (int) (from.width / Settings.FilterTextureResolutionDivider),
            (int) (from.height / Settings.FilterTextureResolutionDivider));
        ...
        RenderTexture BlurredFilteredScene = ApplyBlur(FilteredScene, sourceTexture, Settings.BloomBlurRadius,
            Settings.BloomBlurTextureResolutionDivider, Settings.BloomBlurIterations);
