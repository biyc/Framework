...
namespace Main
{
    public static class RectTransformExtension
    {
        ...
        public static void CopyRectTransform(this RectTransform rect, RectTransform target) {
            ...
            rect.localEulerAngles = new Vector3(target.localEulerAngles.x, target.localEulerAngles.y,
        ...
        public static void Hide(this Transform tr) {
            tr.gameObject.SetActive(false);
        }

        public static void Show(this Transform tr) {
        ...
        public static Animator GetAnimator(this Transform tr) {
            return tr.gameObject.GetAnimator();
        }
        ...
        public static CanvasGroup GetCanvasGroup(this Transform tr) {
            return tr.Comp<CanvasGroup>();
        }

        public static Button GetButton(this Transform tr) {
            return tr.Comp<Button>();
        }
