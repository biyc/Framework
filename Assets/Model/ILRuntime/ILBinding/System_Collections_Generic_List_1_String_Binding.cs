...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_List_1_String_Binding
    {
            ...
            if (genericMethods.TryGetValue("ConvertAll", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Collections.Generic.List<System.Int32>), typeof(System.Converter<System.String, System.Int32>)))
                    {
                        ...
                        app.RegisterCLRMethodRedirection(method, ConvertAll_0);
        ...
        static StackObject* ConvertAll_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
