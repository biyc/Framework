...
{
    unsafe class System_Collections_Generic_Dictionary_2_String_AudioMixerGroup_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.String, UnityEngine.Audio.AudioMixerGroup>);
            args = new Type[]{};
            method = type.GetMethod("Clear", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Clear_0);
            args = new Type[]{typeof(System.String), typeof(UnityEngine.Audio.AudioMixerGroup)};
        ...
        static StackObject* Clear_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Dictionary<System.String, UnityEngine.Audio.AudioMixerGroup> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, UnityEngine.Audio.AudioMixerGroup>)typeof(System.Collections.Generic.Dictionary<System.String, UnityEngine.Audio.AudioMixerGroup>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.String, UnityEngine.Audio.AudioMixerGroup>();
