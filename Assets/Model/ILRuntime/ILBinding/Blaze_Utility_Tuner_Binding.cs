...
{
    unsafe class Blaze_Utility_Tuner_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Blaze.Utility.Tuner);
        ...
        static StackObject* Log_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Blaze.Utility.Tuner.Log(@format, @args);
        ...
        static StackObject* Error_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Blaze.Utility.Tuner.Error(@format, @args);
        ...
        static StackObject* Warn_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Blaze.Utility.Tuner.Warn(@format, @args);
