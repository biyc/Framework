...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Model_Base_Blaze_Manage_Archive_ArchiveData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Model.Base.Blaze.Manage.Archive.ArchiveData);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Save", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Save_0);
            args = new Type[]{typeof(System.String)};
            ...
            field = type.GetField("CreateDate", flag);
            app.RegisterCLRFieldGetter(field, get_CreateDate_0);
            app.RegisterCLRFieldSetter(field, set_CreateDate_0);
            app.RegisterCLRFieldBinding(field, CopyToStack_CreateDate_0, AssignFromStack_CreateDate_0);


        }


        static StackObject* Save_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.String @archiveName = (System.String)typeof(System.String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            var result_of_this_method = instance_of_this_method.Save(@archiveName);
