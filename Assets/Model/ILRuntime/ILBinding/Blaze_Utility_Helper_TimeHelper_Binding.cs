...
{
    unsafe class Blaze_Utility_Helper_TimeHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Blaze.Utility.Helper.TimeHelper);
            args = new Type[]{};
        ...
        static StackObject* ClientNow_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Blaze.Utility.Helper.TimeHelper.ClientNow();
