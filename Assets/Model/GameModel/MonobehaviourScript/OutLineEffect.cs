...
public class OutLineEffect : BaseMeshEffect
{
    ...
    protected override void Start()
    {
        ...
        _asset = Res.LoadAssetSync("Assets/Projects/Materials2/OutLine/OutLine.shader", typeof(Shader));
        _asset.AddRef();
        // Res.LoadAsset("Assets/Projects/Materials2/OutLine/OutLine.shader", delegate (Shader shader)
        // {
        // if (!_isDipose)
        // var shader = Shader.Find("TSF Shaders/UI/OutlineEx");
        base.graphic.material = new Material(_asset.Get<Shader>());
