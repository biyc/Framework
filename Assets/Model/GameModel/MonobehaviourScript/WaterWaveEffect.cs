...
public class WaterWaveEffect : PostEffectBase
{
    ...
    void Update()
    {
        if (enableFlag && inputFlag) return;
    ...
    public void ManualInputFlag(bool cantUpdate1)
    {
        this.inputFlag = cantUpdate1;
    }

    public void ManualEnableFlag(bool cantUpdate2)
    {
        this.enableFlag = cantUpdate2;
    }
}